...
Instead of opening the WebUntis website every time, this app shows the most important information in one place.

You can quickly check things like:
...
The app runs in the system tray, allowing you to open a small popup window to quickly see your data. There is also a larger window with tabs for a more detailed view.
...
licensed under the MIT License. See [`LICENSE-WebUntisAPI`](./LICENSE-WebUntisAPI) for details.
