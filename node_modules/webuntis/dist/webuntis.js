...
const _Base = class _Base {
   ...
   * @param {boolean} [disableUserAgent=true] If this is true, axios will not send a custom User-Agent
   */
  constructor(school, username, password, baseurl, identity = "Awesome", disableUserAgent = true) {
...
class WebUntisSecretAuth extends InternalWebuntisSecretLogin {
   ...
   * @param {boolean} [disableUserAgent=true] If this is true, axios will not send a custom User-Agent
   */
  constructor(school, user, secret, baseurl, identity = "Awesome", authenticator, disableUserAgent = true) {
...
class WebUntisQR extends WebUntisSecretAuth {
   ...
   * @param {boolean} [disableUserAgent=true] If this is true, axios will not send a custom User-Agent
   */
  constructor(QRCodeURI, identity, authenticator, URL, disableUserAgent = true) {
...
class WebUntisAnonymousAuth extends InternalWebuntisSecretLogin {
   ...
   * @param {boolean} [disableUserAgent=true] If this is true, axios will not send a custom User-Agent
   */
  constructor(school, baseurl, identity = "Awesome", disableUserAgent = true) {
